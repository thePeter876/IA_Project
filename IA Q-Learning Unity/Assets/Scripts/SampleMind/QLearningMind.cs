    ...
    public class QLearningMind : AbstractPathMind
    {
        ...
        public override Locomotion.MoveDirection GetNextMove(BoardInfo boardInfo, CellInfo currentPos, CellInfo[] goals)
        {
            if (!generadaTablaQ)                                                        // Si la tablaQ no ha sido generada aún
            {
                ...
                string nombreArchivo = "./tablasQ/" + cargador.seed + ".txt";           // Definimos el nombre del fichero en el cual esta la tabla Q como la ruta, el número de la semilla y el tipo de archivo
